document.addEventListener("DOMContentLoaded", () => {
  ...
  // ローカルストレージの内容をデバッグで確認
  console.log('Initial todos from localStorage:', todos);
  ...
  form.addEventListener("submit", (e) => {
    ...
    // 新しいToDoを配列に追加し、localStorageに保存
  ...
  window.addEventListener("storage", (e) => {     // localStorageに対する変更が別のタブやウィンドウで行われたときに起動
    if (e.key === 'todos') {
